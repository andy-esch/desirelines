...
export const DailySummary: MessageFns<DailySummary> = {
  encode(message: DailySummary, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.daily).forEach(([key, value]: [string, DailyActivity]) => {
...
export const YearMetadata: MessageFns<YearMetadata> = {
  encode(message: YearMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.totals).forEach(([key, value]: [string, SportTotals]) => {
