import activities2023 from "./activities/2023/metrics/cycling.json";
import activities2024 from "./activities/2024/metrics/cycling.json";
import activities2025 from "./activities/2025/metrics/cycling.json";
import type { RideBlobType } from "../../types/activity";
import type { GoalsForYear } from "../../types/generated/user_config";

// Map of year -> fixture data for cycling activities
