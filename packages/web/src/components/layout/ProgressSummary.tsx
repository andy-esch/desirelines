    ...
    <div className="px-4 pt-4 pb-2">
      ...
      <div className="flex justify-between text-sm">
        ...
        {/* Same face and weight as the value above it: these are a pair, read together, and
            ...
            as the projection, in the theme accent rather than the brand cyan: this sidebar is
            themed, unlike the header, which is pinned dark whatever the theme. */}
        <span
          className="font-semibold"
          style={{ textShadow: `0 0 12px ${tint("--color-accent-cyan", 20)}` }}
        >
