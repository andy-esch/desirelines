...
describe("GoalControls", () => {
  ...
  describe("Inline Validation", () => {
    ...
    it("validates non-integer values", () => {
      render(<GoalControls {...defaultProps} />);
      ...
      // Enter decimal value
      fireEvent.change(editInput, { target: { value: "1500.5" } });
      fireEvent.blur(editInput);

      // Should show validation error
      expect(screen.getByRole("alert")).toHaveTextContent("Goal must be a whole number");
    });
