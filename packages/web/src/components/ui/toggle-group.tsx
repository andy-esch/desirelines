...
function ToggleGroupItem({
  ...
  return (
    <BaseToggle
      className={cn(
        "inline-flex items-center justify-center gap-1.5 rounded-(--toggle-item-radius) border-(length:--toggle-item-border-width) border-border px-2.5 py-1 text-(length:--toggle-font-size) leading-[calc(1.25/0.875)] font-medium tracking-(--toggle-tracking) text-foreground [text-transform:var(--toggle-case)] outline-none transition-colors",
