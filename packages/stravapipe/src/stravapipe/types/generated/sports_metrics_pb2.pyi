...
class SportMetrics(_message.Message):
    ...
    def __init__(
        self,
        timeseries: _Iterable[CumulativeMetricsEntry | _Mapping] | None = ...,
    ) -> None: ...
...
class YearMetadata(_message.Message):
    ...
    class TotalsEntry(_message.Message):
        ...
        def __init__(
            self,
            key: str | None = ...,
            value: SportTotals | _Mapping | None = ...,
        ) -> None: ...
