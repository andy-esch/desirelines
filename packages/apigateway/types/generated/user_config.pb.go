...
type UserConfig struct {
	...
	Goals         map[string]*SportGoalsForYear  `protobuf:"bytes,10,rep,name=goals,proto3" json:"goals,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // key = year (e.g., "2025")
...
type SportGoalsForYear struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Sports        map[string]*GoalsForYear `protobuf:"bytes,1,rep,name=sports,proto3" json:"sports,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // key = sport (e.g., "cycling", "running", "yoga")
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_user_config_proto_rawDesc = "" +
	"\n" +
	"\x11user_config.proto\x12\x15desirelines.config.v1\"\xdb\x04\n" +
	"\n" +
	"UserConfig\x12%\n" +
	...
	"\bmetadata\x18\r \x01(\v2\x1f.desirelines.config.v1.MetadataR\bmetadata\x1ab\n" +
	"\n" +
	"GoalsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12>\n" +
	"\x05value\x18\x02 \x01(\v2(.desirelines.config.v1.SportGoalsForYearR\x05value:\x028\x01\x1ai\n" +
	"\x10AnnotationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12?\n" +
	"\x05value\x18\x02 \x01(\v2).desirelines.config.v1.AnnotationsForYearR\x05value:\x028\x01\"\xc1\x01\n" +
	"\x11SportGoalsForYear\x12L\n" +
	"\x06sports\x18\x01 \x03(\v24.desirelines.config.v1.SportGoalsForYear.SportsEntryR\x06sports\x1a^\n" +
	"\vSportsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x129\n" +
	"\x05value\x18\x02 \x01(\v2#.desirelines.config.v1.GoalsForYearR\x05value:\x028\x01\"A\n" +
	"\fGoalsForYear\x121\n" +
	...
	"\n" +
	"updated_at\x18\t \x01(\tR\tupdatedAt\"\xa0\x02\n" +
	"\vPreferences\x12\x14\n" +
	"\x05theme\x18\x01 \x01(\tR\x05theme\x12!\n" +
	"\fdefault_year\x18\x02 \x01(\x05R\vdefaultYear\x12K\n" +
	"\x0echart_defaults\x18\x03 \x01(\v2$.desirelines.config.v1.ChartDefaultsR\rchartDefaults\x12#\n" +
	"\rdistance_unit\x18\x04 \x01(\tR\fdistanceUnit\x12%\n" +
	"\x0eelevation_unit\x18\x05 \x01(\tR\relevationUnit\x12#\n" +
	"\rdefault_sport\x18\x06 \x01(\tR\fdefaultSport\x12\x1a\n" +
	"\btimezone\x18\a \x01(\tR\btimezone\"Q\n" +
	"\rChartDefaults\x12!\n" +
...
var file_user_config_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
